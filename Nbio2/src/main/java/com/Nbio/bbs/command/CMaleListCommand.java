...
public class CMaleListCommand implements CCommand {
	
	@Override
	public void execute(HttpServletRequest request, HttpServletResponse response,HttpSession session) {  
		
		dao dao = new dao();
		int count = dao.selectCnt("product where hT = '남성'"); //전체 행 개수
		...
		ArrayList<PrDto> v = dao.selectPage("product where hT = '남성'", startPage, onePageCnt);
		request.setAttribute("maleProduct", v);
