...
<%@ include file = "header.jsp" %>
	...
	<h3>배송지 수정사항</h3>
				...
				<form action="#" name="join" method="post" id= "form1">
				<input type="text" id="sample4_postcode" placeholder="우편번호" readonly="readonly">
				<input class="finish1" type="button" onclick="sample4_execDaumPostcode()" value="우편번호 찾기"><br>
	
				<input type="text" name="sample4_jibunAddress" readonly="readonly"
					id="sample4_jibunAddress" placeholder="지번주소" size="40"><br>

				<input type="text" name="sample4_roadAddress" readonly="readonly"
					id="sample4_roadAddress" placeholder="도로명주소" size="40"><br>
